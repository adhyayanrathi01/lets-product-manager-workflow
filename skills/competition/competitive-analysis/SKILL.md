...
3. Prefer current primary sources for product capabilities, pricing, policies, and positioning.
4. Record the source and observation date.
5. Separate verified facts from interpretation and inference.
6. Compare workflows and outcomes, not only feature checklists.
7. Identify parity expectations, meaningful differentiation, underserved needs, and trade-offs.
8. Connect findings to existing customer and product evidence.
9. Present strategic options and questions for the PM.

Avoid declaring a “winner” without decision-specific criteria.
